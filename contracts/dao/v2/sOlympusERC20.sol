...
contract sOlympus is IsOHM, ERC20Permit {
    ...
    constructor() ERC20DAO("Staked OHM", "sOHM", 9) ERC20Permit("Staked OHM") {
    ...
    function transfer(address to, uint256 value) public override(IERC20DAO, ERC20DAO) returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 value
    ) public override(IERC20DAO, ERC20DAO) returns (bool) {
    ...
    function approve(address spender, uint256 value) public override(IERC20DAO, ERC20DAO) returns (bool) {
    ...
    function balanceOf(address who) public view override(IERC20DAO, ERC20DAO) returns (uint256) {
    ...
    function circulatingSupply() public view override returns (uint256) {
        return
            _totalSupply.sub(balanceOf(stakingContract)).add(gOHM.balanceFrom(IERC20DAO(address(gOHM)).totalSupply())).add(
    ...
    function allowance(address owner_, address spender) public view override(IERC20DAO, ERC20DAO) returns (uint256) {
