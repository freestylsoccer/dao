...
contract LiquidityMigrator is OlympusAccessControlled {
    ...
    IERC20DAO internal immutable oldOHM = IERC20DAO(0x383518188C0C6d7730D91b2c03a03C837814a899);
    IERC20DAO internal immutable newOHM = IERC20DAO(0x64aa3364F17a4D01c6f1751Fd97C2BD3D7e7f1D5);
    ...
    function migrateLP(
        ...
        IERC20DAO(pair).approve(address(routerFrom), oldLPAmount);
        ...
        IERC20DAO(token).approve(address(routerTo), amountToken);
        ...
        IERC20DAO(token).safeTransfer(authority.governor(), IERC20DAO(token).balanceOf(address(this)));
    }
}
